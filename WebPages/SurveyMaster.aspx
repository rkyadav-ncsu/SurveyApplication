...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div style="width:100%; margin:15px 5px 5px 5px; font-size:large">
    <asp:GridView runat="server" ID="gv_SurveyMaster" AutoGenerateEditButton="false" AutoGenerateColumns="false" CellPadding="2">
        <Columns>
            ...
            <asp:HyperLinkField HeaderText=""  DataTextField="ArtifactId" DataTextFormatString="Check Reviews" DataNavigateUrlFields="ArtifactId" DataNavigateUrlFormatString="artifact.aspx\?id={0}"  ItemStyle-HorizontalAlign="Center"/>
        </Columns>
    </asp:GridView>
        </div>
</asp:Content>
